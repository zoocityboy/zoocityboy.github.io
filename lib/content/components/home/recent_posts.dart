  ...
  Component build(BuildContext context) {
    ...
    return section(classes: 'space-y-8 pb-20', [
      div(classes: 'flex items-center justify-between', [
        ...
        a(href: prefixPath('/posts'), classes: 'text-sm font-semibold transition-colors hover:text-foreground', [.text('All')]),
      ]),
        ...
        if (recent.isEmpty)
          ...
          return article(classes: 'pb-card p-6', [
            ...
            h3(classes: 'mt-3 text-xl font-semibold tracking-tight text-card-foreground', [
              a(href: post.url != null && post.url.startsWith('/') ? prefixPath(post.url) : post.url, classes: 'transition-colors hover:text-foreground', [Component.text(title)]),
            ]),
